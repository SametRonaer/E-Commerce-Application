...
class SecondCategoryEditListTile extends StatelessWidget {
  SecondCategoryEditListTile({Key? key, required this.secondCategoryModel})
      : super(key: key);
                      ...
                      GestureDetector(
                          ...
                          onTap: () {
                            ...
                            Navigator.of(context)
                                .pushNamed(SecondCategoryEditScreen.routeName);
                          },
                          child: Container(
