...
import 'package:alfa_application/screens/edit_screens/category_edit_screen/category_add_edit_screens/ui/web_category_edit_screen.dart';
...
class WebCategoryEditListTile extends StatelessWidget {
  WebCategoryEditListTile({Key? key, required this.categoryModel})
      : super(key: key);
                ...
                Row(
                  ...
                  children: [
                    Container(
                        ...
                        height: 70,
                        width: 60,
                        child: Image.network(categoryModel.categoryImageUrl)),
                    Padding(
                    ...
                    children: [
                      GestureDetector(
                          ...
                          onTap: () {
                            ...
                            context
                                .read<WebHomeCubit>()
                                .switchCurrentScreen(WebCategoryEditScreen());
                          },
                          child: Container(
